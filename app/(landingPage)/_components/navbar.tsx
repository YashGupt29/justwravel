...
export function NavigationMenuBar() {
  ...
  return (
    <div className="flex justify-between py-[20px] px-[130px] shadow-bottom-lg">
      <Link href="/">
          ...
          <NavigationMenuItem>
            ...
            >
              <NavigationMenuLink className={navigationMenuTriggerStyle()}>
                <span className="text-muted-foreground text-[17px]  font-normal">
                  Backpacking Trips
                </span>
              </NavigationMenuLink>
            </Link>
      ...
      <div className="flex gap-[40px] items-center justify-center">
        ...
        <Button className="bg-blue-600 w-[50px] h-[50px]  rounded-full  flex justify-center items-center hover:bg-blue-300">
